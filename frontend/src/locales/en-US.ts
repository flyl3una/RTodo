...
export default {
  ...
  settings: {
    ...
    defaultLogPath: 'Default Path',
    logRolling: 'Rolling Policy',
    rollingDaily: 'Daily',
    rollingHourly: 'Hourly',
    rollingMinutely: 'Minutely',
    rollingNever: 'Never',
    logCompress: 'Auto Compress',
    logRetention: 'Retention Days',
    days: 'days',
    logFiles: 'Log Files',
    refreshLogFiles: 'Refresh List',
    manualCompress: 'Manual Compress',
    compressNow: 'Compress Now',
    selectLogDirectory: 'Select Log Directory',
    changeLogDirectory: 'Change Log Directory',
  },
  ...
  messages: {
    ...
    logLevelChanged: 'Log level has been changed',
    logLevelChangeFailed: 'Failed to change log level',
    logDirectoryChanged: 'Log directory has been changed',
    logDirectoryChangeWarning: 'Changing log directory requires restarting the application. Continue?',
    logRollingChanged: 'Rolling policy has been changed',
    logCompressEnabled: 'Auto compress enabled',
    logCompressDisabled: 'Auto compress disabled',
